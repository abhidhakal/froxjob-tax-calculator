    ...
    <div className="min-h-screen">
        ...
        <div className="relative">
          ...
          {result && (
            <div className="space-y-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-md border border-gray-200 p-6">
                <h3 className="text-lg sm:text-lg md:text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Tax Slab Breakdown</h3>
          ...
          <div className="space-y-6 mt-8">
            <h3 className="text-xl sm:text-xl md:text-2xl font-bold text-gray-800 border-b border-gray-200 pb-2">Result Card Copy for Design Review — the original displays after calculation</h3>
